...
# PC-Relate
    #TODO: revisit adding more iterations?
    #TODO: add option for small sample correction on/off!
...
mypcrelate <- pcrelate(genoData,
                       ...
                       small.samp.correct = TRUE, # 5000 < 7036 => FALSE
...
if (e_vals_neg > 0) {
    print("There are ", e_vals_neg, " negative eigenvalues:")
